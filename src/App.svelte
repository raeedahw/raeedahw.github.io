...
<style lang="scss">
  ...
  .x-logo-img {
   ...
   filter: invert(32%) sepia(99%) saturate(7268%) hue-rotate(313deg) brightness(95%) contrast(111%);
...
<main style="max-width: {MAX_WIDTH}px">
  ...
  <header>
    ...
    <div>
      <p class="resume"><a href="https://drive.google.com/file/d/17cay8LiKDV1kjAgBKaOdohGgVRDXOAgY/view?usp=sharing" target="_blank">Resume (+ awards)</a></p>
    </div>
  </header>
